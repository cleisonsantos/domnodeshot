...
Recursos principais:
- seleção visual estilo DevTools;
- hit-test com maior precisão perto do cursor;
- cancelamento rápido com tecla Esc;
- navegação por teclado (seta para cima = pai, seta para baixo = primeiro filho);
...
- processamento ocorre localmente no navegador do usuário.
...
## Suporte
Definir email de suporte no painel CWS.

## Site
Opcional. Pode usar URL do repositório.
